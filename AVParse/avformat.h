...
typedef struct AVStream {
	...
	void *mcnDecodeExt;		/* mcn extension */
	void *mcnEncodeExt;		/* mcn extension */
...
int av_open_output_stream(AVFormatContext **ic_ptr,
                         ByteIOContext *pb, const char *filename,
                         AVOutputFormat *fmt, AVFormatParameters *ap);
...
#define AV_FILE_OPEN_OK		0
#define AV_FILE_OPEN_FAIL	-1
...
int av_open_output_file(AVFormatContext **ic_ptr, 
						const char *filename,
                       AVOutputFormat *fmt,
                       int buf_size,
                       AVFormatParameters *ap,
