...
#define FFDSHOW_CODECS \
 ...
 CODEC_OP(CODEC_ID_ADPCM_SBPRO_4     ,21,"") \
 CODEC_OP(CODEC_ID_WMAV1             ,22,"wmav1") \
 CODEC_OP(CODEC_ID_WMAV2             ,23,"wmav2") \
 CODEC_OP(CODEC_ID_MACE3             ,27,"mace3") \
 CODEC_OP(CODEC_ID_MACE6             ,28,"mace6") \
 ...
 CODEC_OP(CODEC_ID_ADPCM_SBPRO_2     ,53,"") \
 CODEC_OP(CODEC_ID_THEORA            ,54,"theora") \
 CODEC_OP(CODEC_ID_ADPCM_SBPRO_3     ,56,"") \
 ...
 CODEC_OP(CODEC_ID_ZMBV              ,96,"zmbv") \
 ...
 \
  CODEC_OP(CODEC_ID_ALAC		 ,1701,"alac") \
 \
 CODEC_OP(CODEC_ID_PCM_S32LE     ,1702,"pcms32le") \
 \
 CODEC_OP(CODEC_ID_PCM_S24LE     ,1703,"pcms24le") \
 \
 CODEC_OP(CODEC_ID_AMR_WB		 ,1704,"amrwb") \
 \
 CODEC_OP(CODEC_ID_RAWVIDEO		 ,1704,"rawvid") \
 \
 CODEC_OP(CODEC_ID_DNXHD		 ,1704,"dnxhd") \
 \
 CODEC_OP(CODEC_ID_DIRAC		 ,1704,"dirac") \
 \
